# Calculadora simples que soma dois números usando Tkinter
# Autor: Douglas Hiohine
...
botao_subtrair = tk.Button(janela, text="Subtrair", command=subtrair_numeros)
botao_subtrair.grid(row=3, columnspan=2, padx=10, pady=5)
